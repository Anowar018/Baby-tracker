...
void init_sms()
{
  ...
  delay(400);
  Serial.println("AT+CMGS=\"+8801822265260\"");   // use your 10 digit cell no. here
  delay(400);
}
...
{
    init_sms();
    send_data("Baby Tracking Alert:");
    send_data("Your Baby Current Location is:");
